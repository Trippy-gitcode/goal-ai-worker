...
```
Error: Unexpected errors during test: [pageerror] Cannot read properties of null (reading 'classList'); [pageerror] Cannot read properties of null (reading 'classList')

expect(received).toHaveLength(expected)

Expected length: 0
Received length: 2
Received array:  ["[pageerror] Cannot read properties of null (reading 'classList')", "[pageerror] Cannot read properties of null (reading 'classList')"]
```
