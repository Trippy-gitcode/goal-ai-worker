...
- Name: test01-checklist.spec.ts >> UX Checklist v1 >> C. TALK Screen >> C-03: Old routing badge text not displayed in UI
- Location: tests/e2e/specs/test01-checklist.spec.ts:511:7
...
- generic [ref=e1]:
  ...
  - navigation [ref=e99]:
    ...
    - button "TALK" [active] [ref=e105] [cursor=pointer]:
      - img [ref=e106]
