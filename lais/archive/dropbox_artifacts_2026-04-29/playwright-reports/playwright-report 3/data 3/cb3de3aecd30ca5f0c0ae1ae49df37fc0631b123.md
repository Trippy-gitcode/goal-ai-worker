...
- Name: test01-checklist.spec.ts >> UX Checklist v1 >> G. Legacy Code Cleanup >> G-11: No null reference errors from old page IDs
- Location: tests/e2e/specs/test01-checklist.spec.ts:1024:7
...
```
Error: Unexpected errors during test: [pageerror] Cannot read properties of null (reading 'classList'); [console.error] Failed to load resource: the server responded with a status of 429 (Too Many Requests) (chat)

expect(received).toHaveLength(expected)

Expected length: 0
Received length: 2
Received array:  ["[pageerror] Cannot read properties of null (reading 'classList')", "[console.error] Failed to load resource: the server responded with a status of 429 (Too Many Requests) (chat)"]
```
