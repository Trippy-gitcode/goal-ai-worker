...
- Name: test05-auth.spec.ts >> TEST-05: Auth / Security >> 5-4. Input sanitization >> Empty string submit -> not sent or shows error message
- Location: tests/e2e/specs/test05-auth.spec.ts:333:7
