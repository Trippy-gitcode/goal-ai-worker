...
- Name: test05-auth.spec.ts >> TEST-05: Auth / Security >> 5-1. Auto-register >> With token -> logged in state, all features usable
- Location: tests/e2e/specs/test05-auth.spec.ts:82:7
