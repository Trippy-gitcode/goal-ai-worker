...
- Name: test08-edge.spec.ts >> TEST-08: Edge Cases >> 8-1. Chat input edge cases >> Send during AI response -> queued or blocked
- Location: tests/e2e/specs/test08-edge.spec.ts:143:7

# Error details

```
Error: Unexpected errors during test: [console.error] Failed to load resource: the server responded with a status of 429 (Too Many Requests) (stream); [console.error] Failed to load resource: the server responded with a status of 429 (Too Many Requests) (stream); [ai-error] AI応答にエラーメッセージ: "エラーが発生しました。02:41"; [ai-error] AI応答にエラーメッセージ: "エラーが発生しました。"

expect(received).toHaveLength(expected)

Expected length: 0
Received length: 4
Received array:  ["[console.error] Failed to load resource: the server responded with a status of 429 (Too Many Requests) (stream)", "[console.error] Failed to load resource: the server responded with a status of 429 (Too Many Requests) (stream)", "[ai-error] AI応答にエラーメッセージ: \"エラーが発生しました。02:41\"", "[ai-error] AI応答にエラーメッセージ: \"エラーが発生しました。\""]
```
    ...
    - generic [ref=e21]:
      ...
      - generic [ref=e38]:
        ...
        - generic [ref=e61]:
          - img [ref=e63]
          - generic [ref=e65]:
            - generic [ref=e66]: second message
            - generic [ref=e67]:
              - text: 02:41
              - generic [ref=e68]:
                - button "コピー" [ref=e69] [cursor=pointer]:
                  - img [ref=e70]
                - button "引用" [ref=e73] [cursor=pointer]:
                  - img [ref=e74]
                - button "編集して再送信" [ref=e77] [cursor=pointer]:
                  - img [ref=e78]
        - generic [ref=e81]:
          - img [ref=e83]
          - generic [ref=e86]:
            - generic [ref=e87]: エラーが発生しました。
            - generic [ref=e88]: 02:41
      - button "タスク化" [ref=e90] [cursor=pointer]:
        - img [ref=e91]
        - generic [ref=e94]: タスク化
      - generic [ref=e98]:
        - generic [ref=e99]:
          - generic [ref=e100] [cursor=pointer]: ←
          - generic [ref=e102]: タスク名
        - generic [ref=e105]:
          ...
          - generic [ref=e107] [cursor=pointer]:
            - img [ref=e108]
            - text: 進め方を聞く
          - generic [ref=e110] [cursor=pointer]: → 詰まりを相談
          - generic [ref=e111] [cursor=pointer]:
            - img [ref=e112]
            - text: 30分で終わらせる
        - generic [ref=e116]:
          - textbox "このタスクについて質問する…" [ref=e117]
          - button [ref=e118] [cursor=pointer]:
            - img [ref=e119]
  - navigation [ref=e121]:
    - button "TODAY" [ref=e122] [cursor=pointer]:
      - img [ref=e123]
      - generic [ref=e126]: TODAY
    - button "TALK" [ref=e127] [cursor=pointer]:
      - img [ref=e128]
      - generic [ref=e130]: TALK
    - button "GOALS" [ref=e131] [cursor=pointer]:
      - img [ref=e132]
      - generic [ref=e136]: GOALS
    - button "ME" [ref=e137] [cursor=pointer]:
      - img [ref=e138]
      - generic [ref=e141]: ME
  - generic [ref=e143]:
    - generic "画像を添付" [ref=e144] [cursor=pointer]:
      - img [ref=e145]
    - textbox "返信する" [active] [ref=e149]
    - button "音声入力" [ref=e150] [cursor=pointer]:
      - img [ref=e151]
