...
- Location: tests/e2e/specs/test08-edge.spec.ts:285:7

# Error details

```
Error: Unexpected errors during test: [pageerror] Cannot read properties of null (reading 'classList'); [console.error] Failed to load resource: the server responded with a status of 429 (Too Many Requests) (chat); [pageerror] Cannot read properties of null (reading 'classList'); [console.error] Failed to load resource: the server responded with a status of 429 (Too Many Requests) (chat); [pageerror] Cannot read properties of null (reading 'classList'); [console.error] Failed to load resource: the server responded with a status of 429 (Too Many Requests) (chat)

expect(received).toHaveLength(expected)

Expected length: 0
Received length: 6
Received array:  ["[pageerror] Cannot read properties of null (reading 'classList')", "[console.error] Failed to load resource: the server responded with a status of 429 (Too Many Requests) (chat)", "[pageerror] Cannot read properties of null (reading 'classList')", "[console.error] Failed to load resource: the server responded with a status of 429 (Too Many Requests) (chat)", "[pageerror] Cannot read properties of null (reading 'classList')", "[console.error] Failed to load resource: the server responded with a status of 429 (Too Many Requests) (chat)"]
```
