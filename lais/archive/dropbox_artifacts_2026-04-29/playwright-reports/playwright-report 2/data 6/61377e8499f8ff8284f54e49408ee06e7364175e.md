...
- Name: test08-edge.spec.ts >> TEST-08: Edge Cases >> 8-1. Chat input edge cases >> Multibyte chars (CJK + Arabic) -> normal save and display
- Location: tests/e2e/specs/test08-edge.spec.ts:102:7

# Error details

```
Error: Unexpected errors during test: [console.error] Failed to load resource: the server responded with a status of 429 (Too Many Requests) (stream); [ai-error] AI応答にエラーメッセージ: "エラーが発生しました。02:41"; [ai-error] AI応答にエラーメッセージ: "エラーが発生しました。"

expect(received).toHaveLength(expected)

Expected length: 0
Received length: 3
Received array:  ["[console.error] Failed to load resource: the server responded with a status of 429 (Too Many Requests) (stream)", "[ai-error] AI応答にエラーメッセージ: \"エラーが発生しました。02:41\"", "[ai-error] AI応答にエラーメッセージ: \"エラーが発生しました。\""]
```
    ...
    - generic [ref=e21]:
      ...
      - generic [ref=e38]:
        ...
        - generic [ref=e41]:
          - img [ref=e43]
          - generic [ref=e45]:
            - generic [ref=e46]: 日本語中文한국어العربية
            - generic [ref=e47]:
              - text: 02:41
              - generic [ref=e48]:
