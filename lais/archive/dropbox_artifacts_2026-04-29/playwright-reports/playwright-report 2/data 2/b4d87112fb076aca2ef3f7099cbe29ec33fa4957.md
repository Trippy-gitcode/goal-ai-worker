...
- Name: test03-layout.spec.ts >> TEST-03: Layout / Collision / Display >> 3-10. Icons / SVG >> All pages: zero emoji text (SVG only)
- Location: tests/e2e/specs/test03-layout.spec.ts:844:7

# Error details

```
Error: Unexpected errors during test: [pageerror] Cannot read properties of null (reading 'parentNode'); [pageerror] Cannot read properties of null (reading 'classList'); [console.error] Failed to load resource: the server responded with a status of 429 (Too Many Requests) (chat)

expect(received).toHaveLength(expected)

Expected length: 0
Received length: 3
Received array:  ["[pageerror] Cannot read properties of null (reading 'parentNode')", "[pageerror] Cannot read properties of null (reading 'classList')", "[console.error] Failed to load resource: the server responded with a status of 429 (Too Many Requests) (chat)"]
```
