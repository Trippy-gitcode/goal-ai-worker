...
- Name: test03-layout.spec.ts >> TEST-03: Layout / Collision / Display >> 3-4. Half modal >> Half modal: background overlay darkens
- Location: tests/e2e/specs/test03-layout.spec.ts:279:7
...
- generic [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e20]:
      ...
      - generic [ref=e53]:
        - generic [ref=e54]:
          - generic [ref=e55]: タスクを追加
          - button "✕" [ref=e56] [cursor=pointer]
        - generic [ref=e58]: やりたいことを入力してください
        - generic [ref=e59]:
          - textbox "やりたいことを入力..." [active] [ref=e60]
  ...
  - navigation [ref=e65]:
    ...
    - button "TALK" [ref=e71] [cursor=pointer]:
      - img [ref=e72]
      - generic [ref=e74]: TALK
    - button "GOALS" [ref=e75] [cursor=pointer]:
      - img [ref=e76]
      - generic [ref=e80]: GOALS
    - button "ME" [ref=e81] [cursor=pointer]:
      - img [ref=e82]
      - generic [ref=e85]: ME
```
