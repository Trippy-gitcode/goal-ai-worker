...
- Name: test03-layout.spec.ts >> TEST-03: Layout / Collision / Display >> 3-1. Bottom tabs and content collision >> ME: bottom section not hidden by bottom tabs
- Location: tests/e2e/specs/test03-layout.spec.ts:136:7

# Error details

```
Error: Unexpected errors during test: [console.error] Failed to load resource: the server responded with a status of 429 (Too Many Requests) (chat); [pageerror] Cannot read properties of null (reading 'parentNode')

expect(received).toHaveLength(expected)

Expected length: 0
Received length: 2
Received array:  ["[console.error] Failed to load resource: the server responded with a status of 429 (Too Many Requests) (chat)", "[pageerror] Cannot read properties of null (reading 'parentNode')"]
```
