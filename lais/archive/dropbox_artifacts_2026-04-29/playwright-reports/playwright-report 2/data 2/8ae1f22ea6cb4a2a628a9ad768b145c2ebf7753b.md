...
- Name: test03-layout.spec.ts >> TEST-03: Layout / Collision / Display >> 3-3. FAB button positioning >> + button (task add): tappable and not blocked by other elements
- Location: tests/e2e/specs/test03-layout.spec.ts:260:7
