...
- **Next:** キュー空
- **Last done:** P39+P1+P33+P28 ✅ UX改善4件一括。本番12/12 PASS
...
### ARCH-09: ✅ 完了（2026-04-11 v4.0.40）
> STATUS: DONE

**実装:**
- preact-bridge.js routeToScreenに _cleanupSharedUI() 追加
- サイドバー/タスク詳細パネル/モーダルオーバーレイ/タスク追加/FB/チャット履歴を画面遷移時に一括クリーンアップ
- BUG-05再発防止の構造的ゲート（タスク詳細パネル閉鎖をrouteToScreenに統合）

**テスト:**
- arch-09.spec.ts 5/5 PASS（AT-1〜AT-4+Stress）@ localhost+本番
- canopy: PASS
